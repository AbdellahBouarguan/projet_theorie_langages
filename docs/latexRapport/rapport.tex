...
\item \textbf{Nafissa} : Responsable de l'intégration globale des modules et conceptrice de l'interface utilisateur interactive (le menu principal dans \texttt{main.c}). Elle a aussi activement participée au développement du module d'analyse syntaxique (\texttt{parser.c}).
\end{itemize}
